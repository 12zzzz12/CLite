...
class Type {
	...
	final static Type Exponetial = new Type("double");
...
class ExponetialValue extends Value {
	private double value = 0;

	ExponetialValue() {
		type = Type.Exponetial;
	}

	ExponetialValue(double v) {
		this();
		value = v;
		undef = false;
	}
	...
	public void display(int k) {
		...
		System.out.print("ExponetialValue: ");
		System.out.println(value);
	}
}
